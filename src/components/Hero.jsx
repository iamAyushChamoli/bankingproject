    ...
    md:flex-row flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi quisquam necessitatibus officiis impedit, maxime itaque dolores aliquam voluptate molestias voluptates obcaecati voluptas saepe earum soluta repellendus a, nam nesciunt aliquid!
        </p>
      </div>
